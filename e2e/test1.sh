...
# Simple E2E Test - Single Namespace ConfigMap
...
main() {
    log "Starting Simple E2E Test 1 - Namespace-Centric Config"
    ...
    # Start Faro
    log "Starting Faro with namespace-centric config..."
    timeout 60s $FARO_BIN -config="configs/simple-test-1.yaml" > "$log_file" 2>&1 &
    local faro_pid=$!
    ...
    # Check both the main log and the Faro internal logs
